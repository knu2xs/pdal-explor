...
Experimenting to see about getting PDAL working.
...
```
    ...
    ├── setup.py           <- Setup script for the library (pdal_explor)
    ...
    │   ├── pdal-explor.aprx <- ArcGIS Pro project.    
    │   └── pdal-explor.tbx  <- ArcGIS Pro toolbox associated with the project.
    ...
    └── src                <- Source code for use in this project.
        └── pdal_explor <- Library containing the bulk of code used in this 
                                                  project. 
```
